                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <a href="{{ route('university.create') }}" class="btn btn-primary float-right">Add University</a>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('university.edit', $university->id) }}" class="btn btn-primary">Edit</a></td>
                                        <td>
                                            <form action="{{ route('university.destroy', $university->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
